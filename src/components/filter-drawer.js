...
/* ============================================================
   PUBLIC WRAPPER — called by home.js after drill-down updates APP_FILTER
   so the drawer reflects the new scope when opened.
   ============================================================ */
function syncDrawerToFilter() {
  _syncDraftFromFilter();
}
